...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng marker1 = new LatLng(52.2515976, 76.9687401); // 12 месяцев
    static final LatLng marker2 = new LatLng(52.2518486, 76.9695407); // Сулпак
    static final LatLng marker3 = new LatLng(52.2527997, 76.9710855); // Технодом
    static final LatLng marker4 = new LatLng(52.2542888, 76.9580856); // Inmart
    static final LatLng marker5 = new LatLng(52.2505361, 76.9503469); // Small
    static final LatLng marker6 = new LatLng(52.2611381, 76.9587471); // Fix Price
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.mes)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker2).title((getString(R.string.marker2_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.sulpak)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.technodom)).alpha(ALPHA).
                snippet(getString(R.string.marker3_txt_click)));

        mMap.addMarker(new MarkerOptions().position(marker4).title((getString(R.string.marker3_title))).icon(
        ...
        mMap.addMarker(new MarkerOptions().position(marker6).title((getString(R.string.marker6_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.fix)).alpha(ALPHA).
